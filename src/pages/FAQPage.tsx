...
const faqData = [
  {
    ...
    qas: [
      ...
      { q: '能否只做部分功能？', a: '可以！我們接受模組化合作，您可依預算或優先順序分段開發，彈性調整。' },
      { q: '合作前會簽約嗎？', a: '會的，我們會簽訂承攬合約，詳細說明開發項目、時程、付款方式與智慧財產歸屬等，保障雙方權益。' },
      { q: '需求變更怎麼處理？', a: '需求如有新增或調整，我們會先討論並重新估算時程與費用，雙方確認後再進行。' },
      { q: '專案完成後還能追加功能嗎？', a: '可以，後續如需擴充功能，我們會視需求規模評估追加報價與工期。' },
    ],
  },
  {
    category: '時程',
    qas: [
      { q: '開發時程多久？有提供維護嗎？', a: '時程依專案內容不同，簡單網站約 2-3 週，中大型系統約 4-8 週以上，皆以工作天計算。我們也提供後續維運與修改服務，可另行規劃。' },
      { q: '能否加快時程？', a: '如有急件需求請提前說明，我們會視當期排程安排加速處理（可能需酌收急件費用）。' },
      { q: '專案進度如何追蹤？', a: '每週或每階段會回報進度，可透過 Notion、Slack、LINE 等工具協作。' },
      { q: '上線後多久驗收？', a: '上線前會安排測試與試用期，雙方確認無誤即視為驗收完成。若有保固期，期間內如有異常會免費協助處理。' },
    ],
  },
  {
    category: '付款',
    qas: [
      ...
      { q: '可以開發票嗎？', a: '可以，若需公司開立發票請提供統編與抬頭；個人名義亦可開立收據。' },
      { q: '付款方式有哪些？', a: '可匯款、ATM 轉帳或轉帳到虛擬帳號，依實際情況協議處理。' },
  ...
  },
  {
    ...
    qas: [
      ...
      { q: '能否串接第三方 API？', a: '沒問題，我們有經驗串接金流（如 LINE Pay）、LINE、ERP、物流與各種 API，亦可協助您對接外部平台。' },
    ],
  },
  {
    category: '保固與後續支援',
    qas: [
      ...
      { q: '保固期後要怎麼維護？', a: '可依需求提供維運方案，如：按次收費、月費制或包年合約。維護項目包括功能修改、資料備份、安全檢查等。' },
